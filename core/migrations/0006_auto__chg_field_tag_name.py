...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_tag', 'name', self.gf('django.db.models.fields.SlugField')(max_length=40))

        # Adding index on 'Tag', fields ['name']
        db.create_index('core_tag', ['name'])


    def backwards(self, orm):
        
        # Changing field 'Tag.name'
        db.alter_column('core_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Removing index on 'Tag', fields ['name']
        db.delete_index('core_tag', ['name'])
